import { TOOLBAR_POSITION, TOOLBAR_BUTTON_POSITION,/* TRANSITION_EFFECT,*/ THEME, STEP_STATE, STEP_STATUS, STEP_DIRECTION, STEP_POSITION } from './enums';
...
export type CanEnterExistArgs = boolean | ((args: StepValidationArgs) => boolean|Observable<boolean>);
